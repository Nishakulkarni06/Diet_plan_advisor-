...
const [showModal, setShowModal] = useState(false);
  ...
  navigate(`/diet-plan/${patient.id}`, { state: { patient } });
};
  ...
  {recentPatients.map((p, idx) => (
    <div key={idx} className="py-3 flex items-center justify-between">
      <div className="flex items-center gap-4">
        <div className="w-12 h-12 rounded-lg bg-green-100 dark:bg-slate-700 flex items-center justify-center text-green-700 dark:text-green-300 font-semibold">
      ...
      <div className="flex items-center gap-3">
        ...
        <button 
  onClick={() => handleViewDietPlan(p)} 
  className="px-3 py-1 rounded-lg bg-green-50 dark:bg-slate-700 text-green-600 dark:text-green-300 text-sm font-medium hover:bg-green-100 dark:hover:bg-slate-600 transition"
>
  Open
</button>
...
{selectedPatient?.dietPlan && (
  <div>
    <table className="w-full border-collapse border border-green-300 bg-white shadow-lg rounded-lg">
      ...
      <tbody>
        {Object.entries(selectedPatient.dietPlan).map(([day, meals]) => (
...
{/* Modal for Diet Plan */}
{showModal && selectedPatient?.dietPlan && (
  <div className="fixed inset-0 z-50 flex items-center justify-center">
    ...
    {/* Modal Content */}
    <div className="relative bg-white dark:bg-slate-800 w-full h-full p-6 animate-fadeIn z-50 overflow-y-auto"> 
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">
          Diet Plan - {selectedPatient.fullName}
        </h2>
        <button
          onClick={() => setShowModal(false)}
      ...
      {/* Table */}
      <table className="w-full border-collapse border border-green-300 bg-white dark:bg-slate-900 shadow-lg rounded-lg">
        <thead>
          <tr className="bg-green-600 text-white">
            <th className="border border-green-300 px-4 py-2">Day</th>
            <th className="border border-green-300 px-4 py-2">Breakfast</th>
